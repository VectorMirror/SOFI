...
<html lang="es">
  <head>
    ...
    <title>Alta oficio externo</title>
    <!-- CSS -->
      ...
      <div class="row clearfix"><!--row contentedor-->
        ...
        <div class="tab-content">
          ...
          <div class="tab-pane" id="tab-01">
            <form role="form" action="includes/externo-entrada.php" method="post" enctype="multipart/form-data" autocomplete="off">
              <div class="row">
              ...
              <div class="row">
                ...
                <div class="col-md-6 col-xs-12">
                  ...
                  <div class="col-md-6 col-xs-12">
                    <div class="form-group">      
                      <label for="unidad" class="control-label">Empresa
                        <span class="asteriscoData form-text">*</span>
                      </label>
                      <input type="text" class="form-control"name="buscarEmp" id="buscarEmp" placeholder="Buscar...">
                    <!--En este div de muestran los destinatarios de la tabla destinatrios- en tiempo real-->
                    <div id="suggestionsEmp"></div>
                    <a class="btn btn-primary" data-toggle="modal" data-target="#emp" title="Agregar nueva empresa">+ Empresa</a>
                    </div>
                  </div>
                </div>  
                <!--div donde se mostrara si el remitente se agrego correctamente-->
                <div class="msg-r"></div>    
                <!--div donde se mostrara si ela empresa se agrego correctamente-->
              ...
              <div class="row">
                ...
                <div class="col-md-6 col-xs-12">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control"name="buscarNumeroOf" id="buscarNumeroOf" placeholder="Núumero de oficio...">
              ...
              <div class="row">
                <div class="col-md-6 col-xs-12">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control"name="buscarOficioRef" id="buscarOficioRef" placeholder="Oficio de referencia...">
                  </div>
                </div>
                <div class="col-md-6 col-xs-12">
                  <div class="form-group">
          ...
          <form role="form" action="includes/externo-salida.php" method="post" enctype="multipart/form-data" autocomplete="off">
              <div class="row">
                <h4>Datos del Remitente</h4>
                <hr class="red">
                <div class="col-md-6 col-xs-12">
              ...
              <div class="row">
                ...
                <div class="col-md-6 col-xs-12">
                  <div class="form-group" id="nombre_ft1">
                    <label for="destinatario" class="control-label">Nombre
                      <span class="asteriscoData form-text">*</span>
                    </label>
