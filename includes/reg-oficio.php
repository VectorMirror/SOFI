        ...
        if(count($errores)==0){
            ...
            foreach ($_FILES['archivoOficio']['tmp_name'] as $key => $value){
                ...
                if($_FILES['archivoOficio']['error'][$key]>0 ){
                    ...
                    //restringimos que solo queremos documentos con extension pdf, docx, xls y pptx
                    ...
                    if(in_array($_FILES['archivoOficio']['type'][$key], $extension)){
                        ...
                        $fecha = date('d-m-y'); 
                        $random = rand(999999999, 999999999);
            ...
            if(!empty($oficioUrl)){
                ...
                echo "<script>setTimeout(\"location.href='../oficios.php'\",500); </script>";
            }
            else{
                echo "<script>alert('¡El oficio no se pudo subir :(!'); </script>";
                echo "<script>setTimeout(\"location.href='../subir-oficio-nuevo.php'\",25500); </script>";
            }
        }    
    }
