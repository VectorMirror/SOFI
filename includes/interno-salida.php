<?php
    ...
    $errores = array();
    $caracter= 'Interno-Salida';
    $docOficio= $_FILES['archivoOficioR'];
    ...
    if(!empty($_POST)){
        ...
        if(checarFormInternoSalida($destinatario, $remitente, $cargo, $unidad, $oficioRef, $numOficio, $asunto, $descripcion, $fechaElab)){
            ...
            if($docOficio['error']>0 ){
                ...
                if($docOficio['type']== $extension){
                    ...
                    if(!file_exists($urlDoc)){
                        ...
                        uploadOficioIS($idUser, $caracter, $destId, $remId, $cargo, $unidad, $oficioRef, $numOficio, $asunto, $descripcion, $urlDB, $fechaElab);
                        if($oficioUrl){
