<?php
    ...
    if(!empty($_POST)){
        ...
        $empresa =$_POST['buscarEmp'];
        $oficioRef =strtoupper($_POST['buscarOficioRef']);
        $numOficio =strtoupper($_POST['buscarNumeroOf']);
        ...
        if(checarFormExterno($destinatario, $remitente, $empresa, $oficioRef, $numOficio, $asunto, $descripcion, $fechaElab)){
